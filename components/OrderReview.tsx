      ...
      <div className="relative mx-auto w-full max-w-245">
        ...
        <div className="mt-10 flex justify-center sm:mt-12 gap-3">
          <button
            ...
            className="inline-flex select-none items-center gap-2 rounded-xl bg-[#1F2A44] px-7 py-3.5 text-sm font-bold text-[#FFBF00] shadow-[0_8px_18px_rgba(255,191,0,0.35)] transition-colors duration-150 hover:bg-[#f4b500] active:translate-y-[1px] disabled:cursor-not-allowed disabled:opacity-60"
          ...
          <button
            ...
            disabled={isProcessing}
            className="inline-flex select-none items-center gap-2 rounded-xl text-[#1F2A44] px-7 py-3.5 text-sm font-bold bg-[#FFBF00] shadow-[0_8px_18px_rgba(255,191,0,0.35)] transition-colors duration-150 hover:bg-[#f4b500] active:translate-y-[1px] disabled:cursor-not-allowed disabled:opacity-60"
            style={{ WebkitTapHighlightColor: "transparent" }}
          >
